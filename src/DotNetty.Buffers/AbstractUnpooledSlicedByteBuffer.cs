...
namespace DotNetty.Buffers
{
    ...
    abstract class AbstractUnpooledSlicedByteBuffer : AbstractDerivedByteBuffer
    {
        ...
        protected internal override T _Get<T>(int index) => this.Unwrap().Get<T>(this.Idx(index));
        ...
        protected internal override void _Set<T>(int index, T value) => this.Unwrap().Set<T>(this.Idx(index), value);
